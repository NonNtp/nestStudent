...
let StudentService = class StudentService {
    ...
    async selectCountRegister() {
        return this.connection.query('SELECT register.course_id , count(register.std_id) AS studentNumber FROM register GROUP BY register.course_id');
    }
    async selectJoinCourse() {
        return this.connection.query('SELECT student.std_name  FROM student JOIN register ON student.std_id = register.std_id WHERE register.course_id = "322236"');
    }
};
